...
- **Domain-Driven Design:** Models, DTOs, ViewModels
- **Layered Structure:**
...
See [TESTING.md](TESTING.md) for details on manual and automated testing, test scenarios, and how to run tests.
...
- Add automated test coverage (unit/integration/UI)
